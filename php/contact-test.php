...
define(EMAIL_TO, 'paar@bipolarfactory.com');
define(EMAIL_TO_2, 'anmolvij@gmail.com');
define(EMAIL_BCC, 'sriweb2211@gmail.com');
...
$message .= '<p>Thank you for your interest in PAAR device. We’re excited to hear from you. In response to your enquiry, please find <a href="https://paar.in">paar.in</a> to know more about the product.</p>';
$message .= '<p>We hope the information provided in it answers your queries. Please contact us for clarifications, if any.</p>';
$message .= '<p>We look forward to your association.</p><br><br>';
$message .= '<p>Best Wishes,<br>';
$message .= 'Team PAAR - <b>Bipolar Factory</b>.</p>';
/*$message .= '<table rules="all" style="border-color: #666;" cellpadding="10">';
$message .= "<tr><td style='background: #eee; text-align: center;' colspan='2'><strong>Contact from " . strip_tags($name) . "</strong></td></tr>";
$message .= "<tr><td style='background: #eee;'><strong>Name:</strong> </td><td>" . strip_tags($name) . "</td></tr>";
$message .= "<tr><td style='background: #eee;'><strong>Mobile:</strong> </td><td>" . strip_tags($mobile) . "</td></tr>";
